  ...
  return (
    ...
    <nav className="bg-transparent z-10 fixed w-full border-gray-200 dark:bg-gray-900">
      <div className=" flex flex-wrap items-start justify-between p-4">
        ...
        <button data-collapse-toggle="navbar-default" onClick={hideClick} type="button" className="inline-flex items-center p-2 ml-3 text-sm text-gray-500 rounded-lg md:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600" aria-controls="navbar-default" aria-expanded="false">
